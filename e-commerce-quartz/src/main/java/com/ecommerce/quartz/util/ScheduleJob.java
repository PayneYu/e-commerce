...
import com.ecommerce.common.utils.bean.BeanUtils;
...
public class ScheduleJob extends QuartzJobBean {
    ...
    private ThreadPoolTaskExecutor executor = SpringContextHolder.getBean("threadPoolTaskExecutor");

    private final static ISysJobLogService jobLogService = SpringContextHolder.getBean(ISysJobLogService.class);
