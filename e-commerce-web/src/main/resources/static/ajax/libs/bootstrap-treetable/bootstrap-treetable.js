    ...
    $.fn.bootstrapTreeTable = function (options, param) {
                ...
                $.each(options.columns, function (i, column) {
                    if (column.field != 'selectItem') {
                        ...
                        if (typeof column.visible == "undefined" || column.visible
                            == true) {
                            _li = $('<li role="menuitem"><label><input type="checkbox" checked="checked" data-field="'
                                + column.field + '" value="' + column.field + '" > '
                                + column.title + '</label></li>');
                        } else {
                            _li = $('<li role="menuitem"><label><input type="checkbox" data-field="'
                                + column.field + '" value="' + column.field + '" > '
                                + column.title + '</label></li>');
        ...
        var initHeader = function () {
            ...
            $.each(options.columns, function (i, column) {
                ...
                if (i == 0 && column.field == 'selectItem') {
                    ...
                    $th = $('<th style="' + ((column.width) ? ('width:' + column.width)
        ...
        var renderRow = function (item, isP, lv, row_id, p_id) {
            ...
            $.each(options.columns, function (index, column) {
                ...
                if (column.field == 'selectItem') {
                    ...
                    if (column.formatter) {
                        $td.html(
                            column.formatter.call(this, item[column.field], item, index));
                    } else {
                        if (options.showTitle) {
                    ...
                    if (options.expandColumn == index) {
                        if (!isP) {
                            ...
                            $td.prepend('<span class="treetable-expander ' + _icon
                                + '"></span>')
                        }
        ...
        target.showColumn = function (field, flag) {
            ...
            if (flag && options.showColumns) {
                var $input = $(
                    ".bootstrap-tree-table .treetable-bars .columns label").find("input[value='"
                    + field + "']")
